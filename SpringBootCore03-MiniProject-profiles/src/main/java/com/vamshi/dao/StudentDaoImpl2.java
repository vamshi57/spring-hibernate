...
public class StudentDaoImpl2 implements StudentDao {
	private static final String INSERT_QUERY="insert into student1(sname,mark1,mark2,mark3) values(?,?,?,?)";
	private static final String RETRIVE_QUERY="select * from student1 where sname=?";
	@Autowired
